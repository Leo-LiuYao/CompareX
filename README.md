<div align="center">
  ...
  <p><b>一款轻量、高效的本地多文件夹图像对比与指标分析自用小工具，整合了多个常用图像对比与分析软件的核心功能，更新随心。</b></p>
...
通用看图软件能浏览图片，但难以满足多文件夹同步对比、细节像素级检查及量化分析的需求。**CompareX** 整合了多个图像对比与分析工具的优秀功能，是一个轻量、离线、本地处理的自用小工具。更新随心，旨在偏向“快速检查实验结果”，而不是图库管理器或大型标注平台。
...
- CompareX 纯属个人自用小工具，功能和维护更新随心，优先服务作者本人的实验结果检查需求。
